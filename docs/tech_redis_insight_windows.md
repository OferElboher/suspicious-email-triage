...
Shared Docker/WSL troubleshooting: [stack_guide_windows_docker_databases.md](stack_guide_windows_docker_databases.md).

---

## Related GUI guides

- PostgreSQL (charts): [tech_postgresql_dbeaver_windows.md](tech_postgresql_dbeaver_windows.md)
- MongoDB (reviews): [tech_mongodb_compass_windows.md](tech_mongodb_compass_windows.md)

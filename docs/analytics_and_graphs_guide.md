...
**Prerequisite:** PostgreSQL statistics events must exist (submit reviews or enable dev simulation). See [VERSIONS_BUILDS_AND_SIMULATION.md](VERSIONS_BUILDS_AND_SIMULATION.md).
...
3. Browser refresh (F5) stays on this tab — see [windows_dev_startup_run_guide.md](windows_dev_startup_run_guide.md).
...
Use simulation to populate charts on an empty laptop — see [VERSIONS_BUILDS_AND_SIMULATION.md](VERSIONS_BUILDS_AND_SIMULATION.md).
...
Connect to PostgreSQL `triage_stats` — see [dbeaver_postgresql_windows_setup.md](dbeaver_postgresql_windows_setup.md).
...
- [windows_dev_startup_run_guide.md](windows_dev_startup_run_guide.md) — start stack & open UI
- [DEV_DATABASE_CREDENTIALS.md](DEV_DATABASE_CREDENTIALS.md) — PostgreSQL connection info
- [architecture.md](architecture.md) — Mongo vs PostgreSQL split

...
- [auth_guide_dev_admin_credentials.md](auth_guide_dev_admin_credentials.md) — configure email at setup, forgot-password, provision users
- [tech_postgresql_dbeaver_auth_logs.md](tech_postgresql_dbeaver_auth_logs.md) — inspect `auth_*` in DBeaver, unified logs
- [stack_guide_windows_startup.md](stack_guide_windows_startup.md) — full startup after Windows 11 reboot
...
**Docker rebuilds and passwords:** As of the current `docker-compose.yml`, PostgreSQL data lives in the named volume **`postgres-data`**. Running `docker compose up --build` should **keep** your password hashes. If you previously rebuilt without that volume, Postgres was recreated empty, bootstrap ran again, and only the bootstrap password (`temp-admin-pswd`) worked until you changed it again — see [stack_guide_frontend_api.md](stack_guide_frontend_api.md).
...
Can you sign in?
  |
  +-- YES → change password via Forgot password (Part 2A) or Django admin — see [auth_guide_django_admin_users.md](auth_guide_django_admin_users.md)
  |
...
After a Windows restart, complete [stack_guide_windows_docker_databases.md](stack_guide_windows_docker_databases.md) **Step 0a–0d** (start Docker Desktop, start containers).
...
| `curl` connection refused | Backend not up / Mongo down | [tech_postgresql_dbeaver_auth_logs.md](tech_postgresql_dbeaver_auth_logs.md) Step 1b |
...
- [auth_guide_dev_admin_credentials.md](auth_guide_dev_admin_credentials.md) — day-to-day credential management
- [auth_guide_rbac.md](auth_guide_rbac.md) — roles, permissions, API routes
- [tech_postgresql_dbeaver_auth_logs.md](tech_postgresql_dbeaver_auth_logs.md) — DBeaver auth inspection
- [stack_guide_windows_startup.md](stack_guide_windows_startup.md) — routine startup after reboot

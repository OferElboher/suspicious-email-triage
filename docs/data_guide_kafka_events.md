...
Unit tests validate payload rules and partition hashing without a broker — `ai_service/tests/test_kafka_patterns.py`. Full stack tests are optional when Docker is up — see [stack_guide_pre_push_verification.md](stack_guide_pre_push_verification.md).

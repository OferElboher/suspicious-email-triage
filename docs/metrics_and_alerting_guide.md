...
This guide covers the **in-process metrics and dev-friendly alerts** from [TBD §1.4](TBD.md#14-metrics-and-alerting-p1). You get Prometheus-style scraping and JSON alerts **without** Datadog or Grafana Cloud — though you can point Prometheus/Grafana at the same endpoints later.

**Related:** [health_checks_and_uptime_guide.md](health_checks_and_uptime_guide.md), [AUTHENTICATION_AND_RBAC.md](AUTHENTICATION_AND_RBAC.md), [central_logging_guide.md](central_logging_guide.md).
...
For probe URLs and liveness vs readiness, see [health_checks_and_uptime_guide.md](health_checks_and_uptime_guide.md).
...
| `GET /ops/logs/summary` | JWT + `logs.read` (see [central_logging_guide.md](central_logging_guide.md)) |

...
**Related:** [TBD.md §1.6](TBD.md#16-review-full-text-search-elasticsearch--implemented-free-dev-path), [rest_api_reference.md](rest_api_reference.md), [env_configuration_guide.md](env_configuration_guide.md), [windows_docker_databases_start_and_verify.md](windows_docker_databases_start_and_verify.md).
...
- Production should enable TLS, authentication, and network isolation; managed offerings (Elastic Cloud, OpenSearch on AWS) are paid paths — see [TBD.md](TBD.md).
...
- Run tests: [running_tests_guide.md](running_tests_guide.md) (`searchApi`, `reviewSearchIndex`).
- Broader API listing: [rest_api_reference.md](rest_api_reference.md).
- Log lines for indexing failures: [central_logging_guide.md](central_logging_guide.md).

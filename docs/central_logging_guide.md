...
This guide describes the **free-path central logging** implemented for [TBD §1.3](TBD.md#13-central-logging-and-search-p0p1): one **JSON-lines** file shared by Node and Python services, searchable via the API or local tools (**lnav**, **grep**). No OpenSearch or Datadog is required for dev and demos.

**Hands-on viewing (lnav, copy from Docker, curl examples):** [dbeaver_auth_tables_and_unified_log_viewing.md](dbeaver_auth_tables_and_unified_log_viewing.md) — Part 2 and Options A–D.

**Related:** [env_configuration_guide.md](env_configuration_guide.md), [AUTHENTICATION_AND_RBAC.md](AUTHENTICATION_AND_RBAC.md).
...
To browse on the host without API access, copy the file out or bind-mount — see [dbeaver_auth_tables_and_unified_log_viewing.md](dbeaver_auth_tables_and_unified_log_viewing.md#option-b--copy-log-to-wsl-open-in-vs-code--cursor-simple-gui-search).
...
Full commands and Windows paths: [dbeaver_auth_tables_and_unified_log_viewing.md](dbeaver_auth_tables_and_unified_log_viewing.md).
...
- Broader stack checks: [pre_push_tests_and_stack_verification.md](pre_push_tests_and_stack_verification.md).

...
- **Is not:** chart statistics — those are in PostgreSQL (`review_stats_events`). See [dbeaver_postgresql_windows_setup.md](dbeaver_postgresql_windows_setup.md).
...
| Timeout from Windows | Docker/WSL forwarding | Start Docker Desktop; see WSL IP fallback in [windows_docker_databases_start_and_verify.md](windows_docker_databases_start_and_verify.md) |

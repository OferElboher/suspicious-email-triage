...
**Related:** [auth_guide_dev_admin_credentials.md](auth_guide_dev_admin_credentials.md) (bootstrap email/password), [auth_guide_rbac.md](auth_guide_rbac.md) (roles & permissions).
...
Pre-push tests verify this layout when the stack is running — see [stack_guide_pre_push_verification.md](stack_guide_pre_push_verification.md).
...
2. Sign in with your admin email and password — see [auth_guide_dev_admin_credentials.md](auth_guide_dev_admin_credentials.md)
...
To inspect roles and permissions in DBeaver instead, see [tech_postgresql_dbeaver_auth_logs.md](tech_postgresql_dbeaver_auth_logs.md).
...
**Protection:** You **cannot delete your own account** while signed in. The admin performing the delete must use another admin account to remove themselves, or use SQL (see [auth_guide_dev_auth_recovery.md](auth_guide_dev_auth_recovery.md)).
...
- [ui_guide_analytics_charts.md](ui_guide_analytics_charts.md) — Analytics & graphs page
- [stack_guide_pre_push_verification.md](stack_guide_pre_push_verification.md) — pre-push / integration tests

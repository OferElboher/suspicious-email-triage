...
**Related:** [graph_guide_neo4j_phishing.md](graph_guide_neo4j_phishing.md) (architecture), [graph_demo_neo4j_phishing.md](graph_demo_neo4j_phishing.md) (hands-on demo), [stack_guide_windows_docker_databases.md](stack_guide_windows_docker_databases.md) (Docker basics).
...
1. **Docker Desktop** running on Windows — see [stack_guide_windows_docker_databases.md](stack_guide_windows_docker_databases.md) Step 0a.
...
If you already use [DBeaver for PostgreSQL](tech_postgresql_dbeaver_windows.md), you can add a **Neo4j** connection in the same app.
...
| Empty graph in the React UI | Submit reviews with URLs; wait for Celery to finish; see [graph_demo_neo4j_phishing.md](graph_demo_neo4j_phishing.md) |

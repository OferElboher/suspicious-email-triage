/** Jest tests for password-reset email delivery (SMTP / Mailpit). */
...
const { sendPasswordResetEmail, smtpConfigured } = require("../src/auth/email");
...
describe("sendPasswordResetEmail", () => {
  ...
  test("smtpConfigured reflects SMTP_HOST", () => {
  ...
  test("sendMail is called when SMTP is configured", async () => {
    process.env.SMTP_HOST = "mailpit";
